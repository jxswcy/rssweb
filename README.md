...
- **多 AI 提供方**：支持 OpenRouter（推荐）、OpenAI、Google Gemini、Anthropic Claude、DeepSeek，可自定义模型
...
- **Multiple AI providers**: OpenRouter (recommended), OpenAI, Google Gemini, Anthropic Claude, DeepSeek — with custom model support
...
*Built by [jxswcy](https://github.com/jxswcy) · Powered by Claude Sonnet 4.6*
